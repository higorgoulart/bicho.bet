...
function Footer() {
    return (
        <div className="fixed bottom-0 w-full">
            <footer className="footer bg-secondary text-white p-10">
                <div className="mt-10">
            ...
            <footer className="footer px-10 py-4 bg-secondary text-white">
                <aside className="items-center grid-flow-col">
                    <p>A Bicho.bet aceita apenas clientes com mais de 18 anos de idade. Apostar pode ser viciante. Jogue responsavelmente. <br /> © 2023 Bicho.bet Todos os direitos reservados.</p>
                </aside>
