...
export default function Deposit() {
    ...
    const handleButtonClick = async () => {
      const url = `http://localhost:8080/apostadores/depositar/${id}`;
    ...
    return (
        ...
        <div className="flex justify-center mt-[5%]">
            <div className="card w-[100%] bg-secondary space-y-5 mt-3 mx-3 px-5 py-12 mb-24 lg:w-[70%] md:w-[90%] md:px-24 md:py-12 ">
                <h1 className="flex card-title justify-center text-white" >Depósito</h1>
                <h2 className="flex justify-center">Quanto você vai depositar hoje?</h2>
                <span>R$</span>
                <input className="bg-primary py-2 p-2 rounded-md" type="number" value={inputValue} onChange={handleInputChange} min="0"/>
                <button className="btn btn-accent text-white glow-blue" onClick={handleButtonClick}>Depositar!</button>
